...
public class ServerConf {
	...
	private HashMap<Integer, ResourceConf> asMap() {
		if (idToRsc != null)
		{	System.out.println("idtorsc is : "+idToRsc.size());
			return idToRsc;
		}
		if (idToRsc == null) {
			System.out.println("idToRsc is null!!");
			synchronized (this) {
				if (idToRsc == null) {
			...
			System.out.println("Now the id to rsc is : "+idToRsc.size()+" and its value at 4 is "+idToRsc.get(4));
		}
	...
	public ResourceConf findById(int id) {
		ResourceConf temp=asMap().get(id);
