...
public class HeartbeatData {
	...
	/*system usage of every connected node is stored in its respective haertbeat
	 * data objects. Leader uses this information at time of choosing between multiple nodes 
	 * to route the request 
	 * */
	
	private static  float systemUsage;
