...
public class ResourceUtil {
	 ...
	 */
	public static Request buildForwardMessage(Request req, ServerConf cfg, Integer nextNode) {
	...
	public static Request buildError(Header reqHeader, PokeStatus status, String statusMsg) {
		...
		bldr.setHeader(hdr);
		Payload.Builder pbl=Payload.newBuilder();
		
		bldr.setBody(pbl.build());
		// TODO add logging
